  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      axios
        ...
        .catch((err) => console.log("Cannot fetch balance"));
    };
    fetchData();
  }, []);
          ...
          >
            <AppRipple
              ...
              onPress={() => {
                ...
                axios
                  .get(
                    "https://utl-proxy.vercel.app/api/v1/getvirtualaccounts",
                    {
                      headers: {
                  ...
                  .catch((err) => {
                    console.error("Cannot fetch virtual accounts");
                  });
              }}
            >
              <ReceiveSquare2
